...
|---------|------|---------|---------|
| **[2.0.0](changelog/2.0.0.md)** | 2026-09-09 | 🌐 Site Independence Architecture | Major architectural release decoupling the bot from ttfm-socket through framework specifications, normalized state/events/messages, pluggable socket/API/messaging adapters, capability-aware actions, and Hang regression coverage. Establishes the foundation for multi-site support. |
